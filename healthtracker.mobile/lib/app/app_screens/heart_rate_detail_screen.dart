...
class _HeartRateDetailScreenState extends State<HeartRateDetailScreen> {
  late HeartRateRecord _currentRecord;
      ...
      builder: (context) {
        return AlertDialog(
          ...
          actions: [
            ...
            TextButton(
              onPressed: () async {
                await DatabaseHelper.instance.deleteHeartRateRecord(_currentRecord.id);
                if (context.mounted) {
  ...
  Future<void> _navigateToEdit() async {
    final updated = await Navigator.of(context).push<HeartRateRecord>(
      MaterialPageRoute(
        builder: (context) => HeartRateAddRecordScreen(
          heartRateRecordToEdit: _currentRecord,
        ),
      ),
    );
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  children: [
                    ...
                    // Measurement Status Tag & Demographics Card
                    Container(
                      width: double.infinity,
                      padding: const EdgeInsets.all(18),
                      decoration: BoxDecoration(
